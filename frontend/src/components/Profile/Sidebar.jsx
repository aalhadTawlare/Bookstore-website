...
const Sidebar = ({data}) => {
  ...
  return (
    <div className='bg-zinc-800 h-auto lg:h-[100%] p-4 rounded flex flex-col items-center justify-between'>
        ...
        {role === 'admin' && (
          ...
          <Link to='/profile/addbook' className='text-zinc-100 font-semibold w-full py-2 text-center hover:bg-zinc-900 rounded transition-all'>
          Add book
          </Link>
      </div>
        )}
